...
<reference>
@E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/user-profiling.md` to load:
