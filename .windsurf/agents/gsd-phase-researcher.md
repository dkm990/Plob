...
@E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/thinking-models-research.md
...
```bash
node "E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
