...
<!-- For checkpoint task examples and patterns, see @E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/checkpoints.md -->
...
See `E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/workflows/verify-phase.md` for verification logic.
