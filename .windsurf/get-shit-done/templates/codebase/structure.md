...
- Usage: Reference from command with `@E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
