...
```bash
INIT=$(node "E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/templates/spec.md.
