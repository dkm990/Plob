...
- **Global scope**: `E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/notes/`)
...
2. Glob `E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/notes/*.md` (if directory exists) — global notes
...
Global (E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/notes/):
...
2. **No `.planning/`**: Falls back to global `E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/notes/` — works in any directory
