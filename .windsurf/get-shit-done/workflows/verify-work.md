...
<template>
@E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/workflows/transition.md`.
...
- Follow @E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/workflows/diagnose-issues.md
