...
```bash
INIT=$(node "E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/bin/gsd-tools.cjs" init plan-phase "$PHASE")
...
```bash
PHASE_INFO=$(node "E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
```
...
```bash
node "E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/bin/gsd-tools.cjs" state planned-phase --phase "${PHASE}" --name "${phase_name}" --plans "${PLAN_COUNT}"
```
