...
```markdown
Read E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/agents/gsd-ui-researcher.md for instructions.
...
Template: E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/agents/gsd-ui-checker.md for instructions.
