...
INSTALL_JS_GLOBAL="E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
