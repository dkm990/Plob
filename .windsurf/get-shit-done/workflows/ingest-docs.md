...
```bash
INIT=$(node "E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/bin/gsd-tools.cjs" commit \
