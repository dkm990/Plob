...
> `E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/USER-PROFILE.md` exists). Skip the Read
...
```bash
PROFILE_CONTENT=$(cat "E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a `Agent()` in parallel:
   ...
   ```
   Agent(
     prompt="First, read @E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/agents/gsd-advisor-researcher.md for your role and instructions.
