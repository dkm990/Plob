...
See E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/templates/discovery.md
...
Use E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/templates/discovery.md.
