...
```
Agent(
  prompt="Read E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/templates/SECURITY.md`
