...
Key references:
- @E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/ui-brand.md (display patterns)
- @E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/agents/gsd-user-profiler.md (profiler agent definition)
- @E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/USER-PROFILE.md"
...
```bash
cp "E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/USER-PROFILE.md" "E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/USER-PROFILE.backup.md"
```
...
✓ Stores profile at E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/user-profiling.md`
...
Reference: @E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .windsurf/rules" -- "Add profile to E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/.windsurf/rules for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/.windsurf/rules"
...
```bash
BACKUP_PATH="E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/USER-PROFILE.backup.md"
```
...
Your profile:    E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/skills/gsd-dev-preferences/SKILL.md
  ✓ .windsurf/rules section       .windsurf/rules
  ✓ Global .windsurf/rules        E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/.windsurf/rules
```
