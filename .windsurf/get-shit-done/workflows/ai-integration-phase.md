...
<required_reading>
@E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/ai-frameworks.md
@E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/agents/gsd-eval-planner.md for instructions.
