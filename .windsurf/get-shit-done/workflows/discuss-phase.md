...
<required_reading>
@E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/domain-probes.md
@E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/gate-prompts.md
@E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@E:/FEST/V2/Plans-master (3)/Plans-master/.windsurf/get-shit-done/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
